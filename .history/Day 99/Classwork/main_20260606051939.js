...
//     colorCangerDiv.style.backgroundColor='red'
// })
// blue.addEventListener('click', () => {
//     colorCangerDiv.style.backgroundColor = 'blue';
// });

//ბონუსი
const ColorCangerDiv = document.getElementById
const ColorCangerButton =document.getElementById('ColorCangerButton')
ColorCangerButton.addEventListener("click",()=>){
    if (ColorCangerButton==='red') {
